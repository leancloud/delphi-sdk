...
{$ENDIF UNICODE}
  ...
  protected
    ...
    function BuildJsonString(ABuilder: TQStringCatHelperW; var p: PQCharW):Boolean;
    ...
    procedure CatValue(ABuilder: TQStringCatHelperW; const S: QStringW;
      ADoEscape: Boolean);
    ...
    function SkipSpaceAndComment(var p: PQCharW): Integer;
...
function TQJson.BuildJsonString(ABuilder: TQStringCatHelperW; var p: PQCharW):Boolean;
var
  AQuoter: QCharW;
  ps: PQCharW;
begin
...
procedure TQJson.CatValue(ABuilder: TQStringCatHelperW; const S: QStringW;
  ADoEscape: Boolean);
var
  ps: PQCharW;
const
...
function TQJson.InternalEncode(ABuilder: TQStringCatHelperW; ADoFormat: Boolean;
  ...
  if (ANode.Parent <> nil) and (ANode.Parent.DataType <> jdtArray) and
    ...
    CatValue(ABuilder, ANode.FName, ADoEscape);
...
//            raise Exception.CreateFmt(SObjectChildNeedName, [ANode.Name, I]);
    ...
    jdtString:
      ...
      CatValue(ABuilder, ANode.FValue, ADoEscape);
...
function TQJson.SkipSpaceAndComment(var p: PQCharW): Integer;
begin
SkipSpaceW(p);
Result := 0;
...
function TQHashedJson.HashName(const S: QStringW): TQHashType;
var
  ATemp: QStringW;
begin
if JsonCaseSensitive then
